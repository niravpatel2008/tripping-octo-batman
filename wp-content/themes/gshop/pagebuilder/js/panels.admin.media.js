...
jQuery(function($){
    ...
    wp.media.editor.insert = function(h){
        ...
        if(h.indexOf('[gallery') !== -1) {
            ...
            var panel = $('#panels-dialog').panelsCreatePanel('Nemo_Panels_Widgets_Gallery', {
                'ids' : ids.join(',') 
            });
            ...
            if($el.prop("tagName") == 'A' && $el.children().eq(0 ).prop('tagName') == 'IMG'){
                ...
                panel = $('#panels-dialog').panelsCreatePanel('Nemo_Panels_Widgets_Image', {
                    'href' : $el.attr('href'),
                ...
                panel = $('#panels-dialog').panelsCreatePanel('Nemo_Panels_Widgets_Video', {
                    'url' : $el.attr('href' )
                });
            }
