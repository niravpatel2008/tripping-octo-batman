...
(function($) {
	...
	$(document).on('panelsopen', function() {
		var $text_area = $('.ui-dialog:visible textarea[id^=widget-tinymce]');
		$('.ui-dialog:visible input[id^=widget-tinymce][id$=type][value=visual]').each(function() {
			$('.ui-dialog:visible a[id^=widget-tinymce][id$=visual]').click();
		});
