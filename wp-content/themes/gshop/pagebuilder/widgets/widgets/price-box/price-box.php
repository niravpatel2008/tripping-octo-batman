...
class Rox_Panels_Widget_Price_Box extends Rox_Panels_Widget  {
	function __construct() {
		parent::__construct(
			__('Price Box (ROX)', 'so-panels'),
			array(
		...
		$this->add_sub_widget('list', __('Feature List', 'so-panels'), 'Rox_Panels_Widget_List');
	}
}