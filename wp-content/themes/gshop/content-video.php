...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'blog' ); ?>> <!--.last-->
  <div class="blog-thumbnail-video">
    <?php if ( get_post_meta( get_the_ID(), 'post_video_url_id_youtube', true ) != '' ) : ?>
        <div class="video-shortcode">
          <<?php echo $tagname; ?> title="YouTube video player" width="100%" height="400" src="http://www.youtube.com/embed/<?php echo get_post_meta( get_the_ID(), 'post_video_url_id_youtube', true ); ?>" frameborder="0" allowfullscreen></<?php echo $tagname; ?>>
        </div>
        
        <?php elseif( get_post_meta( get_the_ID(), 'post_video_url_id_vimeo', true ) != '' ):?>
        <div class="video-shortcode">
          <<?php echo $tagname; ?> src="http://player.vimeo.com/video/<?php echo get_post_meta( get_the_ID(), 'post_video_url_id_vimeo', true ); ?>" width="100%" height="400" frameborder="0"></<?php echo $tagname; ?>></div>
    <?php endif; ?>
    </div>
