...
function woocommerce_order_review() {
	global $woocommerce;
	get_template_part( 'inc/woocommerce/review', 'order' );
}

unregister_widget( 'WC_Widget_Random_Products' );

class WC_Widget_Random_Products1 extends WP_Widget {
	...
	function __construct() {
		$this->id_base = 'woocommerce_random_products_a';
		$this->name    = __( 'WooCommerce Random Products aaaaa', 'woocommerce' );
