...
function wpcf7_default_form_template() {
	$template =
		'<div class="comment-post">
          <div class="title-content"><h3 class="title">Send Message</h3></div>
          <div class="post-comment-form">
            <form role="form">
			  <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="form-group">
                    [textarea your-message x6 class:form-control placeholder "Message"]
                  </div>
                </div>
                <div class="col-lg-2 col-lg-offset-4">
				[response]
				[submit class:submit-btn "' . __( 'post', 'wpcf7' ) . '"]
                </div>
              </div>
            </form>
          </div>
